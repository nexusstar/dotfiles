...
function M.setup(servers, options)
  ...
  require("mason").setup {
    ui = {
      icons = {
        package_installed = icons.icons.symbols_outline.Module,
        package_pending = icons.icons.symbols_outline.Variable,
        package_uninstalled = icons.icons.symbols_outline.Variable,
      },
    },
  }
